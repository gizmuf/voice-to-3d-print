...
[Watch the reproducible demo](https://github.com/gizmuf/voice-to-3d-print/releases/download/v0.1.0/pulsai-demo.mp4) ·
[Roadmap](ROADMAP.md) ·
[Contributing](CONTRIBUTING.md) ·
[Share feedback](https://github.com/gizmuf/voice-to-3d-print/issues/new/choose)

[![Pulsai 3D deterministic phone-stand edit and print-preparation demo](https://github.com/gizmuf/voice-to-3d-print/releases/download/v0.1.0/pulsai-demo-readme.gif)](https://github.com/gizmuf/voice-to-3d-print/releases/download/v0.1.0/pulsai-demo.mp4)

The demo above is generated by a public GitHub Actions workflow. It starts the
local-safe stack with paid AI disabled, creates the real parametric phone-stand
model, applies a deterministic conversational edit, verifies that the revision
and mesh changed, and prepares a print bundle. The workflow and browser test are
part of this repository so contributors can inspect and reproduce the proof.
...
- **A reviewable CAD tool surface for agents.** Structured parameters, named
  features, revision hashes, manufacturing checks, and deterministic exports
  provide bounded evidence that a coding agent can inspect instead of treating
  an opaque mesh or screenshot as success.
...
The project is early and does not claim broad adoption. The most useful support
today is a reproducible alpha test, a focused issue or pull request, or an
independent verification of the local setup. See the open
[`good first issue`](https://github.com/gizmuf/voice-to-3d-print/labels/good%20first%20issue)
and [`help wanted`](https://github.com/gizmuf/voice-to-3d-print/labels/help%20wanted)
queues.
