...
The public demo workflow starts the local-safe stack with paid AI disabled,
creates the flagship phone stand, applies a deterministic conversational edit,
asserts that both the revision and mesh changed, and prepares a print bundle.

- [Watch the MP4](https://github.com/gizmuf/voice-to-3d-print/releases/download/v0.1.0/pulsai-demo.mp4)
- [View the README GIF](https://github.com/gizmuf/voice-to-3d-print/releases/download/v0.1.0/pulsai-demo-readme.gif)
- [View the final poster](https://github.com/gizmuf/voice-to-3d-print/releases/download/v0.1.0/pulsai-demo-poster.png)
- [Inspect the workflow](https://github.com/gizmuf/voice-to-3d-print/blob/main/.github/workflows/capture-demo.yml)
